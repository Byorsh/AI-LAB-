...
default_args = {
    ...
    # Reemplaza days_ago(1) por una fecha fija o una fecha dinámica con datetime:
    'start_date': datetime(2026, 1, 1), 
    # O alternativamente: datetime.now() - timedelta(days=1),
...
BUCKET_NAME = 'udemy-bucket-test-2026'
